...
public class OutOfStateSales {
    ...
    public static final JsonSerde<TicketWithCustomerAndVenueAndState> SERDE_TICKET_WITH_CUSTOMER_AND_VENUE_AND_STATE_JSON = new JsonSerde<>(TicketWithCustomerAndVenueAndState.class);
